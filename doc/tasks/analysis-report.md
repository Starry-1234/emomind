...
## 实现步骤
1. [ ] 编写 FileAnalysisReport entity
2. [ ] 编写 FileAnalysisReportRepository
3. [ ] 编写 AnalysisService
4. [ ] 编写 AnalysisController
5. [ ] 实现 GET /analysis/reports（列表查询）
6. [ ] 实现 POST /analysis/reports（创建报告）
7. [ ] 实现 GET /analysis/reports/{id}（详情查询）
8. [ ] 实现 DELETE /analysis/reports/{id}（删除报告）
9. [ ] 编写 DTO（request/response）
10. [ ] 编写 MapStruct 映射
11. [ ] 单元测试
